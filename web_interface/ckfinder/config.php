...
*/
$baseUrl = '/daisy/assets/uploadFiles/'.md5($_SESSION['userId']."ChunWaiLeong")."/";
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => "10M",
		'allowedExtensions' => 'csv,doc,docx,fla,flv,gif,jpg,mp3,mp4,mpc,mpeg,mpg,pdf,png,ppt,pptx,rar,swf,tar,tgz,txt,wav,wma,wmv,xls,xlsx,zip',
