...
function parseCameraParam(cameraParamStr)// the whole file as a str
{
	...
	for(var i=0;i<lines.length;++i)
	{
		...
		var cam_look_x=parseFloat(things[3]);
		var cam_look_y=parseFloat(things[4]);
		var cam_look_z=parseFloat(things[5]);
...
function init()
{
	...
	var mouse = null;
	var scene = null;
	var scaleFactor = 1;// all cordinates scale to this for easier navigation
	...
	var initialCameraPos = new THREE.Vector3(-41.2033, -18.5570, 4.5700);
	var initialControlTarget = new THREE.Vector3(-38.8232, -17.5720, 3.6496);
	camera.position.set(initialCameraPos.x,initialCameraPos.y,initialCameraPos.z);
	...
	$("div.main > div.mainControls > div.quickLink > div.hideProjection").trigger(cw.ectype);
