...
<style type="text/css">
	...
	#cPersonDetection input{margin:0}
	#cPersonDetection div.searchVideo > div.guessList{
		padding:5px;
	}
	#cPersonDetection div.searchVideo > div.guessList > div.block{
		padding:5px;
		cursor:pointer;
		border-bottom:1px silver solid;
	}
	#cPersonDetection div.searchVideo > div.guessList > div.block:hover{
		color:gray
	}
	#cPersonDetection div.display > div.block > div.ctr{
		text-align:center;
		padding:10px;
		line-height:40px;
		-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;
	}
	#cPersonDetection div.display > div.block > div.ctr > i{
		cursor:pointer;
	}
	#cPersonDetection > div.left{
		/*
		position:fixed;
		top:45px;
		left:0%;
	...
	#cPersonDetection > div.right{
		margin:0 0 0 40%;
		padding-left:10px;
	}
	#cPersonDetection video{
		width:100%;
	}
	#cPersonDetection > div.left div.title{
		text-align:center;
	}
	#cPersonDetection > div.left > div.preprocessing > div.loadVideoToDatabase > div.progressForImportVideo{
		width:200px;
	}
	#cPersonDetection > div.right > div.personBlocks > div.block {
		margin-bottom:10px;
		border-radius:5px;
...
$(document).ready(function(){
	...
	if($videoname!="")
	{
		?>
	clickOneRun = true;
	$("#cPersonDetection > div.left > div.searchVideo > input.videoname").val("<?php echo $videoname?>");
	$("#cPersonDetection > div.left > div.searchVideo > div.detect").trigger(cw.ectype);
	<?php }else{ ?>
	getRunList(true);
	<?php } ?>
});
	...
	{
		$("#cPersonDetection > div.left > div.uploadVideo > span.info").html("");
		$("#cPersonDetection > div.left > div.preprocessing").hide();
		$("#cPersonDetection > div.left > div.processing").hide();
		return true;
	}
	// succes upload
	function videoUploadOk(data)
	{
		...
		$("#cPersonDetection > div.left > div.uploadVideo > input.newvideoUrl").val(data.url);
		$("#cPersonDetection > div.left > div.uploadVideo > span.info").html("Upload Success");
		$("#cPersonDetection > div.left > div.preprocessing").show();
		// trigger the system to load this video into database
		loadVideo(data.url);
	}
	function videoUploadError(str)
	{
		$("#cPersonDetection > div.left > div.uploadVideo > span.info").html(str);
	}
	...
	function loadVideo(url)
	{
		...
		//alert(url);
		//$("#cPersonDetection > div.left > div.preprocessing > div.loadVideoToDatabase > span.info").html("<div class='wrapLoading'><div class='loading'></div></div>");
		$("#cPersonDetection > div.left > div.preprocessing > div.loadVideoToDatabase > span.info").html("posting request...");
		cw.post("<?php echo Yii::app()->baseUrl?>/index.php/main/importVideo",data,function(result){
			if(result.status == 0)
			{
				//display counting results
				/*
				$("#cPersonDetection > div.left > div.preprocessing > div.loadVideoToDatabase > span.info").html(
				...
				{
					$("#cPersonDetection > div.left > div.preprocessing > div.loadVideoToDatabase > span.info").html("Loading video...");
				}
				else
				{
					$("#cPersonDetection > div.left > div.preprocessing > div.loadVideoToDatabase > span.info").html("Video loaded. Please click Run Person Detection");
				}
	...
	cw.ech("#cPersonDetection > div.left > div.preprocessing > input.importDone",function(){
		$("#cPersonDetection > div.left > div.preprocessing > div.loadVideoToDatabase > span.info").html("Video loaded. Please click Run PersonDetection Detection");
	});
	...
	// person detection!!!
	cw.ec("#cPersonDetection > div.left > div.searchVideo > div.detect",function(){
		// show video first		
		if($(this).hasClass("disabled"))
		{
			return;
		...
		data.videoname = $(this).parent().children("input.videoname").val();
		$(this).addClass("disabled");
		$("#cPersonDetection > div.right > div.ctr").hide();
		$("#cPersonDetection > div.right > div.personBlocks").hide();
		$(this).parent().children("span.info").html('<div class="loading"></div>');
		cw.post("<?php echo Yii::app()->baseUrl?>/index.php/main/searchVideo",data,function(result){
			...
			else
			{
				...
				$("#cPersonDetection > div.right > input.videoname").val(video.videoname);
				//alert(isLeft);
				var $display = $("#cPersonDetection > div.right > div.display");
				...
				$("#cPersonDetection > div.left > div.processing").show();
	...
	cw.ec("#cPersonDetection > div.left > div.searchVideo > div.seeVideo",function(){
		// show video first		
		if($(this).hasClass("disabled"))
		{
			return;
	...
	function postDetectionJob(videoname)
	{
		...
		$("#cPersonDetection > div.left > div.processing > div.personDetection > div.detectionGraph").html("").parent().find("div.info > div.wrapLoading > span.info").html("");
		$("#cPersonDetection > div.left > div.processing > div.personDetection > div.moreResult").hide()
		...
		$("#cPersonDetection > div.left > div.processing > div.personDetection > div.info > div.wrapLoading > span.info").html('<div class="loading"></div>');
		$("#cPersonDetection > div.left > div.processing > input.personDone").val(videoname);// remember it
		cw.post("<?php echo Yii::app()->baseUrl?>/index.php/main/getPersonDetection",data,function(result){
			if(result.status == 0)
			{
				$("#cPersonDetection > div.left > div.processing > div.personDetection > div.info > div.wrapLoading > span.info").html('');
				if(result.haveResult == 1)
				{
					//show the result
					// set the detection graph via runId
					$("#cPersonDetection > div.right > div.ctr").show();
						$("#cPersonDetection > div.right > div.ctr > div.line > input.thres").val(3);
						$("#cPersonDetection > div.right > div.ctr > div.line > input.padding").val(1.0);
					$("#cPersonDetection > div.right > div.personBlocks").show();
					$("#cPersonDetection > div.left > div.processing > div.personDetection > div.detectionGraph").html('<img src="<?php echo Yii::app()->baseUrl?>/assets/personGraph/'+result.runId+'_prob.png"></img>');
					
					//show more result things
					$("#cPersonDetection > div.left > div.processing > div.personDetection > div.moreResult").show();
					var resultType = $("#cPersonDetection > div.left > div.processing > div.personDetection > div.moreResult > div.things > div.resultType > div.type.toggle").html();
					//$("#cPersonDetection > div.left > div.processing > div.personDetection > div.moreResult > div.things > img.original").prop('src','<?php echo Yii::app()->baseUrl?>/assets/personGraph/'+result.runId+'_original.png');
					
					// save the result locally, so that 
					//alert(resultType);
					personResult = result.scoreList;

					segments = getSegments(personResult[resultType],3.0);
					//console.log(segments);
					setSegments(segments);
					//alert(segments.length);
					$("#cPersonDetection > div.right > div.display > div.block > video").get(0).addEventListener("loadedmetadata",function(){
						//alert("done");
						$("#cPersonDetection > div.right > div.ctr > div.line > div.setThres").trigger(cw.ectype);
					});
				...
				{
					$("#cPersonDetection > div.left > div.processing > div.personDetection > div.info > div.wrapLoading > span.info").html('Processing...');
	...
	{
		resetFrameDetection();
		$("#cPersonDetection > div.left > div.processing > div.personDetection > div.frameDetection").show().children("div.loadingFrame").show();
		$("#cPersonDetection > div.left > div.processing > div.personDetection > div.frameDetection > div.frameDetectionImage > img.big").on("progress",function(e){
			//alert("c");
			if(e.lengthComputable)
			{
				//alert('a');
				var progressValue = e.loaded/e.total*100;
				$("#cPersonDetection > div.left > div.processing > div.personDetection > div.loadingFrame > div.progress > div.bar").width(progressValue+"%");
			}
		})
			.on("load",function(){
				//alert("c");
				$("#cPersonDetection > div.left > div.processing > div.personDetection > div.frameDetection > div.loadingFrame").hide().parent().children("div.frameDetectionImage").show();
				...
				var videoObject = videoSource[$("#cPersonDetection > div.right > input.videoname").val()]['object'];
				$(videoObject).on("timeupdate",function(){
					//alert("d");
					if(frameDetectionImageLoaded)
					{
						var pos = parseInt(this.currentTime/detectionLength);
						$("#cPersonDetection > div.left > div.processing > div.personDetection > div.frameDetection > div.frameDetectionImage > img.big").css("left",-onePicWidth*(pos+1));
					}
				});
			})
			.prop("src",src);
	...
	{
		resetFrameDetection();
		$("#cPersonDetection > div.left > div.processing > div.personDetection > div.frameDetection > div.frameDetectionVideo > video > source").prop("src",src);
		detectionVideo = $("#cPersonDetection > div.left > div.processing > div.personDetection > div.frameDetection > div.frameDetectionVideo > video").get(0);
		detectionVideo.load();
		var videoObject = videoSource[$("#cPersonDetection > div.right > input.videoname").val()]['object'];
		$(videoObject).on("timeupdate",function(){
		...
		$("#cPersonDetection > div.left > div.processing > div.personDetection > div.frameDetection").show();
	}
	function resetFrameDetection()
	{
		/*frameDetectionImageLoaded = false;
		//onePicWidth = null;
		$("#cPersonDetection > div.left > div.processing > div.personDetection > div.frameDetection").hide().children("div.loadingFrame").hide().end()
	...
	// set new threshold
	cw.ec("#cPersonDetection > div.right > div.ctr > div.line > div.setThres",function(){
	...
	{
		$("#cPersonDetection > div.right > div.personBlocks").html("");
		var threshold = $("#cPersonDetection > div.right > div.ctr > div.line > input.thres").val();
		// set the timeline stuff
		$("#timeline").html("");
		var duration = $("#cPersonDetection > div.right > div.display > div.block > video").get(0).duration;
		...
		for(var i=0;i<segments.length;++i)
		{
			$("#cPersonDetection > div.right > div.personBlocks").append(
				'<div class="block">'+
					...
					' has maximum '+segments[i].personCount+' person(s) <div class="btn btn-small btn-success playSegment">play person clip</div>'+
				'</div>'
			);
			if(!isNaN(duration))
			{
	...
	var ending = null;
	//click play!!
	cw.ec("#cPersonDetection > div.right > div.personBlocks > div.block > div.playSegment,#timeline > div.block",function(){
		...
		var padding = parseFloat($("#cPersonDetection > div.right > div.ctr > div.line > input.padding").val());
		startSec-=padding;
		endSec+=padding;
	...
	cw.ech("#cPersonDetection > div.left > div.processing > input.personDone",function(){
...
cw.ec("#cPersonDetection > div.left > div.processing > div.personDetection > div.moreResult > div.show > div.showMore",function(){
	$("#cPersonDetection > div.left > div.processing > div.personDetection > div.moreResult > div.things").slideToggle();
});
// toggle different result
cw.ec("#cPersonDetection > div.left > div.processing > div.personDetection > div.moreResult > div.things > div.resultType > div.type",function(){
	$("#cPersonDetection > div.left > div.processing > div.personDetection > div.moreResult > div.things > div.resultType > div.type").removeClass("toggle");
	$(this).addClass("toggle");
	// trigger changing result
	$("#cPersonDetection > div.right > div.ctr > div.line > div.setThres").trigger(cw.ectype);
});
// see existing result.
cw.ec("#cPersonDetection > div.left > div.line > div.runList",function(){
	getRunList();
...
function getRunList()
{
	...
	$("#cPersonDetection > div.right > input.videoTemp").val($("#cPersonDetection > div.right > div.display > div.block > video > source").prop("src")); 
	$("#cPersonDetection > div.right > div.display > div.block > video").prop("src","");
	$("#cPersonDetection > div.right > div.display > div.block > video > source").prop("src","");
...
$(document).delegate("#runListModal","hide",function(){
	...
	if(!clickOneRun)
	{
		if($("#cPersonDetection > div.right > input.videoTemp").val()!= "")
		{
			var oldvideo = $("#cPersonDetection > div.right > input.videoTemp").val();
			//alert(oldvideo);
			$("#cPersonDetection > div.right > div.display > div.block > video > source").prop("src",oldvideo);
			$("#cPersonDetection > div.right > div.display > div.block > video").prop("src",oldvideo);
			$("#cPersonDetection > div.right > div.display > div.block > video").get(0).load();
			$("#cPersonDetection > div.right > input.videoTemp").val("");
		}
	}
	clickOneRun = false;
});
...
cw.ec("#runListModal > div.modal-body > div.block",function(){
	...
	$("#cPersonDetection > div.left > div.searchVideo > input.videoname").val(videoname);
	$("#cPersonDetection > div.left > div.searchVideo > div.detect").trigger(cw.ectype);
});
// delete a run
...
<style type="text/css">
	#cPersonDetection > div.left > div.processing > div.personDetection > div.moreResult{
		display:none;
	}
	#cPersonDetection > div.left > div.processing > div.personDetection > div.moreResult > div.things > div.resultType{
		padding:5px;
		height:30px;
	}
	#cPersonDetection > div.left > div.processing > div.personDetection > div.moreResult > div.things > div.resultType > div.type{
		padding:5px;
		float:left;
		font-weight:bold;
		cursor:pointer;
	...
	#cPersonDetection > div.left > div.processing > div.personDetection > div.moreResult > div.things > div.resultType > div.type.toggle{
		color:white;
		background-color:#49afcd;
	}
	#cPersonDetection #runListModal > div.modal-body > div.block{
		padding:10px;
		cursor:pointer;
		font-weight:bold;
		word-break:break-all;
	}#cPersonDetection #runListModal > div.modal-body > div.block:hover{
		background-color:rgb(220,220,220);
	}
	#cPersonDetection > div.left > div.processing > div.personDetection > div.frameDetection > div.frameDetectionImage{
		height:400px;
		overflow:hidden;
		position:relative;
	}
	#cPersonDetection > div.left > div.processing > div.personDetection > div.frameDetection > div.frameDetectionImage > img.big{
		max-width:none;
		top:0;
		left:0;
		position:absolute;
...
<div id="cPersonDetection">
	...
	<?php if($videoname==""){ ?>
		<div class="line" style="padding:10px;border-bottom:1px silver solid;margin-bottom:10px">
			...
			<span class="muted">Click this to see person detection results of previously uploaded videos</span>
		</div>
			...
			<div class="loadVideoToDatabase">
				...
				<?php 
					$this->widget("ProgressWidget",array(
						...
						"doneCall" => "#cPersonDetection > div.left > div.preprocessing > input.importDone",
						"noMessage" => true,
					));
				?>
				</div>
		...
		<div class="searchVideo" style="padding:5px 0;">
			...
			<?php } ?>
			<div class="btn btn-small btn-success detect">Run Person Detection</div>
			<span class="text-error info"></span>
			<br/>
		...
		<div class="processing" style="border-top:1px solid silver;margin-top:10px;padding:5px;display:none">
			...
			<div class="personDetection">
				<div class="title">Person detection</div>		
				<div class="info">
					...
					<?php 
						$this->widget("ProgressWidget",array(
							"id" => "personProgress",
							"doneCall" => "#cPersonDetection > div.left > div.processing > input.personDone"
						));
					?>
					</div>
				</div>
				<div class="frameDetection" style="display:none" >
					<div class="title"><span class="muted">frame person detection</span></div>
	...
	<div class="right">
		...
		<div class="ctr" style="padding:10px 0px;display:none">
			<div class="line"> 
				Person Count Threshold for PersonDetection: <input class="thres input-small" style="width:50px;" type="text" value=3></input>
